...
class DroneObstacleEnv(gym.Env):
    ...
    def __init__(self, vae_model_path: str, target_position: np.ndarray, 
        ...
        # Acceleration rate: Real drones can accelerate 10-20 m/s�, but for responsive control we use very high value
    ...
    def step(self, action: np.ndarray):
        ...
        if self.enable_drag:
            ...
            # With acceleration_rate = 500 m/s� and dt ? 0.03s, max_accel ? 15 m/s per step
